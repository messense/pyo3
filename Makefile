...
test_py:
	@for example in examples/*/noxfile.py; do echo "-- Running nox for $$example --"; nox -f $$example || exit 1; echo ""; done
	@for package in pytests/*/noxfile.py; do echo "-- Running nox for $$package --"; nox -f $$package || exit 1; echo ""; done
